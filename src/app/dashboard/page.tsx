  ...
  return (
    <div className="space-y-6 pb-10">
      <div>
        ...
        <p className="text-slate-400 mt-1">Your performance command center.</p>
      </div>
        ...
        <Card className="bg-[#111118] border-slate-800/70 shadow-sm relative overflow-hidden">
          ...
          <CardContent className="p-8 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1 space-y-4 text-center md:text-left">
              <h2 className="text-2xl font-semibold text-white tracking-tight">Interview Readiness Score</h2>
              <p className="text-slate-400 max-w-lg mx-auto md:mx-0">
                Based on your recent interview performance and resume analysis.
              </p>
            ...
            <div className="relative flex items-center justify-center w-36 h-36 shrink-0">
              ...
              <div className="absolute flex flex-col items-center justify-center text-white">
                <span className="text-4xl font-bold tracking-tighter">76<span className="text-2xl text-slate-400">%</span></span>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <Card className="bg-[#111118] border-slate-800/70 shadow-sm flex flex-col h-full hover:border-slate-700/50 transition-colors">
                <CardContent className="p-6 flex flex-col h-full">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="font-semibold text-white">Resume Snapshot</h3>
                  </div>
                  ...
                  <div className="space-y-3 flex-1">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-slate-200 font-medium text-emerald-400">72%</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-400">Missing keywords</span>
                      <span className="text-rose-400 font-medium">4 detected</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-400">Strongest category</span>
                      <span className="text-slate-200 truncate ml-2">Frontend Dev</span>
                    </div>
                  </div>

                  <Link href="/dashboard/resume" className="mt-6 flex items-center text-sm text-indigo-400 hover:text-indigo-300 transition-colors font-medium">
                ...
                <CardContent className="p-6 flex flex-col h-full relative z-10">
                  ...
                  <div className="space-y-4 flex-1">
                    <p className="text-slate-300 text-sm leading-relaxed">
                      "System Design" explanations have scored below 70% in 3 of your last 5 interviews.
                    </p>
                    <p className="text-rose-400/80 text-sm leading-relaxed">
                      Consider practicing scalability and architecture fundamentals.
                    </p>
                  </div>
                </CardContent>
              </Card>
          ...
          <Reveal delay={0.4}>
            <Card className="bg-[#111118] border-slate-800/70 shadow-sm h-full flex flex-col">
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <div className="space-y-4 flex-1">
                  ...
                  <div className="flex flex-col gap-1 pb-4 border-b border-slate-800/60">
                    <div className="flex justify-between items-start">
                      <span className="text-sm font-medium text-slate-200">React Interview</span>
                      <span className="text-xs text-slate-500">Feb 10</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-slate-400">
                      <Target className="w-3.5 h-3.5" /> Score: <span className="text-emerald-400 font-medium">82</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-1 pb-4 border-b border-slate-800/60">
                    <div className="flex justify-between items-start">
                      <span className="text-sm font-medium text-slate-200">Node Interview</span>
                      <span className="text-xs text-slate-500">Feb 05</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-slate-400">
                      <Target className="w-3.5 h-3.5" /> Score: <span className="text-amber-400 font-medium">75</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-1 pb-2">
                    <div className="flex justify-between items-start">
                      <span className="text-sm font-medium text-slate-200">Resume Analyzed</span>
                ...
                <Link href="/dashboard/interviews" className="mt-6 flex items-center justify-center w-full py-2.5 rounded-lg border border-slate-800 text-sm font-medium text-slate-300 hover:bg-slate-800 hover:text-white transition-colors">
                  View All Activity
                </Link>
              </CardContent>
            </Card>
