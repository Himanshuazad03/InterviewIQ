...
export function Performance() {
  return (
    <section id="testimonials" className="py-24 bg-gradient-to-bl from-[#16161D] via-[#0B0B0F] to-[#050507]">
              ...
              {metrics.map((metric, index) => (
                <div key={index} className="space-y-3">
                  ...
                  <div className="h-2 w-full bg-[#1F1F2A] rounded-full overflow-hidden">
                    <div
                      className="h-full bg-[#4B5563] rounded-full transition-all duration-1000 ease-out"
