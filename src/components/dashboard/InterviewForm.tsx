...
export default function InterviewForm({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden border-[#1F2937]  shadow-xl shadow-black/50 text-[#F9FAFB]">
        ...
        <Form {...form}>
          ...
          >
            {/* Job Role & Interview Type (2 columns) */}
            ...
            {/* Difficulty & Question Count (2 columns) */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <FormField
                control={form.control}
                name="difficulty"
