...
import { Bell, Menu, X, BrainCircuit, LogOut } from "lucide-react";
    ...
    <>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 flex md:hidden">
          ...
          {/* Sidebar Panel */}
          <aside className="relative w-[260px] max-w-[80%] bg-[#0B0B0F] h-full flex flex-col border-r border-[#1F1F2A] animate-in slide-in-from-left duration-200">
            {/* Close Button */}
            <button
            ...
            <Link
              ...
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-black-600 to-gray-600 flex items-center justify-center shadow-sm">
