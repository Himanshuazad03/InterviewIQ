          ...
          <div className="grid grid-cols-2 gap-12 sm:gap-24 px-4">
            <div>
              ...
              <ul className="space-y-3 text-sm text-[#9CA3AF]">
                ...
                <li><Link href="#pricing" className="hover:text-[#F9FAFB] transition-colors">Pricing</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-[#E5E7EB] font-heading font-semibold mb-4 text-sm uppercase tracking-wider">Legal</h4>
              <ul className="space-y-3 text-sm text-[#9CA3AF]">
                <li><Link href="#" className="hover:text-[#F9FAFB] transition-colors">Privacy Policy</Link></li>
                <li><Link href="#" className="hover:text-[#F9FAFB] transition-colors">Terms of Service</Link></li>
                <li><Link href="#" className="hover:text-[#F9FAFB] transition-colors">Contact</Link></li>
              </ul>
            </div>
          </div>
        </div>
