...
const faqs = [
  {
    ...
    answer: "InterviewIQ evaluates responses using structured prompts across multiple categories including technical accuracy, depth of knowledge, clarity of explanation, and confidence. Final scoring follows a deterministic weighted formula to ensure consistency."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. Your dashboard stores interview history and allows you to track score trends, weak areas, and measurable improvement across multiple sessions."
  },
  {
    question: "Does InterviewIQ support voice interviews?",
  ...
  {
    question: "Who is InterviewIQ designed for?",
    answer: "InterviewIQ is built for students, developers, and professionals preparing for technical and behavioral interviews."
  },
  {
        ...
        <Reveal>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#9CA3AF]">
              Everything you need to know about how InterviewIQ works.
            </p>
          </div>
        </Reveal>
